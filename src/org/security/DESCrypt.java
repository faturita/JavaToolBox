...
class Bits extends BitSet {
    ...
    public String toHex() {
      return String.format("0x%08X", toLong());
    }
...
public class DESCrypt {
    ...
    /**
     * This is the code of the entire algorithm.
     *
     * The flag allows to invert the last permutation which determines if we
     * are ciphering or deciphering.
     **/
